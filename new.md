...
<header class="w3-container grad w3-padding" id="myHeader">
  ...
  <div class="w3-center text">
    ...
    <div class="w3-padding-32">
     <form>
      <input type="button" class="w3-btn w3-xlarge w3-dark-grey w3-hover-light-grey" onclick="document.getElementById('id01').style.display='block' calculate()" style="font-weight:900;" value="calculate">
     </form>
    </div>
  </div>
</header>

...
.menu {
  display: flex;
  position: fixed;
  background: linear-gradient(to right, rgba(255, 255, 255, 0) 0%, rgba(255, 255, 255, 0.5) 5%, rgba(255, 255, 255, 0.52) 6%, rgba(255, 255, 255, 0.7) 10%, rgba(255, 255, 255, 0.9) 100%);
  padding: 0;
  width: 0;
